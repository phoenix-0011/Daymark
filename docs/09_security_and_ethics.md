...
## مسئولیت تیم در امنیت، حریم خصوصی و دسترس‌پذیری

| حوزه | مسئولان |
|---|---|
| مرزهای معماری، اعتبارسنجی دامنه و کنترل خطا | علی ابراهیمی نیا |
| امنیت SQLite، SQL پارامتری، تراکنش و مهاجرت | علی رضا زاده |
| اعتبارسنجی ورودی و جلوگیری از نمایش یا رفتار ناامن UI | امیرحسین رابعی و مهدی ابراهیم زاده |
| دسترس‌پذیری، کنتراست، اندازه کنترل و پرهیز از Dark Pattern | مجتبی محمودی و مهدی نریمانی |
| بازبینی نهایی Privacy و Release Security | تمام اعضای تیم |
...
در نسخه فعلی Daymark حساب کاربری و سرور ندارد؛ بنابراین authentication درون‌برنامه‌ای نیاز عملکردی نیست. کنترل دسترسی به عهده قفل دستگاه و sandbox سیستم‌عامل است.
...
## شواهد و فایل‌های اجرایی امنیت

- [`../SECURITY.md`](../SECURITY.md) — سیاست گزارش آسیب‌پذیری
- [`../PRIVACY.md`](../PRIVACY.md) — نوع داده، انتقال، Log و حذف داده
- [`20_security_verification.md`](20_security_verification.md) — بررسی‌های واقعی و موارد باقی‌مانده
- Secret و Artifact scan در `tools/quality_check.py`
- Bandit و pip-audit در CI به‌صورت Advisory

هیچ ادعای ممیزی مستقل امنیتی یا Production Hardening در این نسخه مطرح نمی‌شود.

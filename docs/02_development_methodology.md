...
برای Daymark، روش **Scrumban** مناسب‌تر از Scrum سنگین یا Waterfall است. محصول رابط‌محور است، بازخورد دستگاه واقعی زیاد دارد و باگ‌های Android معمولاً پس از تست لمسی آشکار می‌شوند. بنابراین به برنامه‌ریزی Sprint نیاز داریم، ولی جریان Kanban برای باگ‌ها و اصلاحات سریع نیز ضروری است.
...
## شواهد واقعی Iteration و محدودیت تاریخی

روند فنی پروژه از روی سورس و اسناد تغییرات در [`14_project_iterations.md`](14_project_iterations.md) بازسازی شده است. برای گذشته، جلسه یا Sprint ساختگی ثبت نشده است. از این نسخه به بعد، Branch، Pull Request، CI و Review باید Evidence اصلی همکاری باشند.

...
CI می‌تواند compile، test، lint و کنترل artifact را انجام دهد. ساخت Android باید در محیط کنترل‌شده و دارای Python 3.11،
JDK 17، Android SDK/NDK و ابزارهای امضا انجام شود.
